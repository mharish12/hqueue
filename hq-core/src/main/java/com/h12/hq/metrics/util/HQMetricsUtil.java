...
//        hqCollectorRegistry.register(new GarbageCollectorMetricSet());
//        hqCollectorRegistry.register(new CachedThreadStatesGaugeSet());
//        hqCollectorRegistry.register(new MemoryUsageGaugeSet());
